	...
	<table border="1">
		...
		<tr class="row">
			...
			<td width="100"><img id="myImg"
				src="<%=request.getParameter("articleImg")%>" border=10 width="200">
			</td>
			<td width="50"></td>
			<td width="100" border=10><img id="myImg2"
				src="<%=request.getParameter("articleImg2")%>" border=10 width="200">
			</td>
			<td width="50"></td>
			<td width="100" border=10><img id="myImg3"
				src="<%=request.getParameter("articleImg3")%>" border=10 width="200">
			</td>
			<td width="20"></td>
