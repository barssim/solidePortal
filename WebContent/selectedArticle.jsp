...
<table border="1">
	<tr class="cell">
		...
		<td width="20"></td>
		<td width="100"><img src="images/pare brise.jpg"
		...
		<td width="600" style="vertical-align: top" width="800">
			...
			style="font-size: 25px; letter-spacing: normal; position: relative; top: 0px;">
				<%=myArticlesList.get(0).getArticleName()%></span> <br> <span
		...
		<td width="20"></td>
		<td width="20" style="vertical-align: top"><h3><%=myArticlesList.get(0).getArticlePrice()%>
				DH
			</h3></td>
	</tr>
</table>
