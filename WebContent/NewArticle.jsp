	...
	<div class="col gu5">
		<form action="NewArticleServlet" method="post"
			...
			<div style="display: inline-block; width: 176px;">
				...
				</label> <input type="text" name="piece" size="20px" required="required">
			</div>
			<br> <br>
			...
			<div style="display: inline-block; width: 176px;">
				...
				<div style="display: inline-block; width: 176px;">
					...
					<div style="display: inline-block; width: 176px;">
						...
						<label class="djaj2"><select id="manif"
							name="constructeur" onChange="onChanger()">
						...
						<div style="display: inline-block; width: 176px;">
							<label style="margin-bottom: 16px;"
								for="fos_user_registration_form_civilite">Modèle: </label> <label
								class="djaj2"><select id="mod" name="model"
								onChange="onChangerMod()">
									<option value="Choisir..." selected="selected">Choisir...</option>
							</select> </label>
							<div style="margin-bottom: 16px;"></div>
							<div style="display: inline-block; width: 176px;">
								<label style="margin-bottom: 16px;"
									for="fos_user_registration_form_civilite">Type: </label> <label
									class="djaj2"><select id="type" name="type">
										<option value="Choisir..." selected="selected">Choisir...</option>
								...
								<div style="display: inline-block; width: 176px;">
									...
									<textarea name="description" rows="5" required="required"></textarea>
								</div>
								<div style="margin-bottom: 16px;"></div>
								<div style="display: inline-block; width: 176px;">
									<label for="fos_user_registration_form_civilite"
										class="required">Prix: </label> <input type="text"
										name="price" size="20px" required="required">
								</div>
								<br> <br>
								...
								<div style="display: inline-block; width: 176px;">
									<label for="fos_user_registration_form_civilite"
										class="required">Image: </label> <input type="file"
										name="myFile1" size="20px" id="fileChooser">
								</div>
								<input type="file" name="myFile2" size="20px" id="fileChooser">
							</div>
							<input type="file" name="myFile3" size="20px" id="fileChooser">
						</div>

						<!--                 <input type="submit" value="Télécharger"> -->
						<br> <br> <input type="submit" value="Inserer">
		</form>
	</div>
</div>
