...
<!-- <form action="SelectedArticleServlet"  method="post" > -->
		...
		<table border="1">
		   ...
		   <td width="600" style="vertical-align: top" width="800"><span
					...
					style="font-size: 15px; letter-spacing: normal; position: relative; top: 0px;"><b>ArticleNo:
							<%=request.getParameter("articleNo")%></b></span>
					<br> <br>
					<span
			...
			<tr class="row">
				...
				<td width="20"></td>
				<td width="100">						
				<img id="myImg" src="<%=request.getParameter("articleImg")%>" onerror="this.src='images/carrosserie.jpg';" border=10 width="200">
					</td>
					<td width="100" border=10>						
				<img id="myImg2" src="<%=request.getParameter("articleImg2")%>" onerror="this.src='images/carrosserie.jpg';" border=10 width="200">
					</td>
					<td width="100" border=10>						
				<img id="myImg3" src="<%=request.getParameter("articleImg3")%>" onerror="this.src='images/carrosserie.jpg';" border=10 width="200">
					</td>
				<td width="20"></td>
	...
	<form action="RemoveArticleServlet" method="post">  
		...
		<br>
		   <input type="submit" value="Editer" onclick="location.href='articleUpdate.jsp?articleNo=<%=request.getParameter("articleNo")%>&articleName=<%=request.getParameter("articleName")%>&articleDesc=<%=request.getParameter("articleDesc")%>&articlePrice=<%=request.getParameter("articlePrice")%>&articleCategory=<%=request.getParameter("articleCategory")%>&articleOldNew=<%=request.getParameter("articleOldNew")%>'"><br>
		<br> <br> <br>
