...
<body>
	<div class="row">
		...
		<div class="col gu2">
			<br> <br> <a class="link" href="NewArticle.jsp"><input
				type="submit" value="Inserer nouveau article"></a>
			<form action="MyArticlesServlet" method="post">
				<a class="link" href="myArticles.jsp"><input type="submit"
					value="Consulter vos offres"></a>
			</form>
			<a class="link" href="profileUpdate.jsp"><input type="submit"
				value="Editer votre profile"></a> <br>
			<div class="col gu1">
				<!-- 	<br> -->
				<!-- 	<br> -->
				<!-- 	<br> -->
